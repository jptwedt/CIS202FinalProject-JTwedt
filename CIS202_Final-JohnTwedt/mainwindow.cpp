    ...
    ui(new Ui::MainWindow)
{
   ...
   QObject::connect(m_lineEditSxMRows, SIGNAL(textChanged(QString)),validator,SLOT(sxmColsEdited(QString)));
   ...
   QObject::connect(m_sxmMatrix, SIGNAL(scalarToFormat(qreal)),textInjector, SLOT(listenSxMScalarRdy(qreal)));
